...
OpenRouter AI를 활용해 영어 웹페이지를 자연스러운 한글로 바꿔주는 크롬 확장 프로그램입니다. 복잡한 기술 용어는 뒤로하고, 실제 사용자 입장에서 필요한 정보만 정리했습니다.
...
## 최근 버그 픽스
- 스크롤 도중 번역이 멈추던 현상을 해결해 페이지 끝까지 자연스럽게 번역돼요.
- 저장한 API Key가 가끔 사라지던 문제를 고쳐 더 이상 다시 입력할 필요가 없어요.
- 원본 보기로 전환하면 문장이 일부 남던 오류를 바로잡아 깔끔하게 복원돼요.
